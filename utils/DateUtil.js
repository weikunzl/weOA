...
String.leftPad = function(str,width,padChar) {
    var ret = str+'';
...
Date.dayNamesCN = ["星期天", "星期一", "星期二", "星期三", "星期四",
		"星期五", "星期六"];
...
Date.getShortDayNameCN = function(day) {
	return Date.dayNamesCN[day].substring(0, 3);
}

Date.prototype.getShortDayNameByDateCN = function() {
    return Date.dayNamesCN[this.getDay()];
}
 ...
 * Date.prototype.setMonth = function(num){ if(num <= -1){ var n =
 * Math.ceil(-num); var back_year = Math.ceil(n/12); var month = (n % 12) ? 12 -
 * n % 12 : 0 ; this.setFullYear(this.getFullYear() - back_year); return
 * Date.brokenSetMonth.call(this, month); } else { return
 * Date.brokenSetMonth.apply(this, arguments); } }; }
 */
