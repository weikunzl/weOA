            ...
            return {
                ...
                , link: function(scope, element, attrs){
                    action.link(attrs.name, attrs.group).success(function(response){
                        ...
                        element.html('<i data-toggle="tooltip" data-placement="top" title="" data-trigger="hover"  data-original-title="'+ data.title +'" class="'+ data.icon + '"></i><span style="margin-left: 4px; class="text">' + data.title + '</span>');
