...
define(function(){
    ...
    var initialize = function(module){
        module.directive('select2', function () {
            return {
                restrict: 'A',
                scope: {
                    config: '=',
...
//                            var tempConfig ={};
//                            if(!scope.config.data||scope.config.length>1){
//                                tempConfig.data = {results:scope.config,text:'type'};
//                                tempConfig.formatSelection = format;
//                                tempConfig.formatResult = format;
//                            }else{
//                                tempConfig = scope.config;
//                            }
